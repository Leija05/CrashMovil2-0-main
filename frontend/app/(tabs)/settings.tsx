          ...
          <View style={styles.section}>
            ...
            <View style={styles.inputGroup}>
              ...
              <Text style={styles.helper}>
                Se usará como patrón de búsqueda para identificar tu módulo. Por defecto se buscan HC-05, HM-10, BT05, AT-09 y CRASH.
              </Text>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.toggleHelper}>
                  {developerMode
                    ...
                    : 'Inactivo: los datos se leen 100% desde tu módulo Bluetooth BLE (HC-05/HM-10/BT05).'}
                </Text>
              </View>
              <Switch
